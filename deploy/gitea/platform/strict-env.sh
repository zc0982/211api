...
gitea_load_image_lock() {
  ...
  while IFS= read -r line || [[ -n "$line" ]]; do
    ...
    value=${line#*=}
    case "$key" in
      GITEA_IMAGE|RUNNER_IMAGE|CADDY_IMAGE|GITEA_POSTGRES_IMAGE|DIND_IMAGE|DOCKER_CLI_IMAGE|GO_CI_IMAGE|NODE_ACTIONS_BASE_IMAGE|GO_ACTIONS_CI_IMAGE|NODE_CI_IMAGE|APP_NODE_IMAGE|APP_GO_IMAGE|APP_ALPINE_IMAGE|APP_POSTGRES_IMAGE)
