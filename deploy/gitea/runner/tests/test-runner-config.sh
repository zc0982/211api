...
jq -e '
  ...
  and .services.docker.mem_limit == "4294967296"
...
source "$LOCK"
set +a
expected_labels="linux-amd64:docker://${NODE_CI_IMAGE},go-1.26.5:docker://${GO_ACTIONS_CI_IMAGE},node-20.20.2:docker://${NODE_CI_IMAGE},docker-29.6.1:docker://${DOCKER_ACTIONS_CI_IMAGE}"
