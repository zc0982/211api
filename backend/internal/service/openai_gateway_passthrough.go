...
func (s *OpenAIGatewayService) handleStreamingResponsePassthrough(
	...
	// The synchronous and asynchronous scan paths below each return this buffer
	// exactly once. A shared defer here would race with the keepalive scanner.
	...
	for {
		...
		case <-keepaliveTicker.C:
			if clientDisconnected || !clientOutputStarted || flushPending {
				continue
			}
