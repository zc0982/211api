...
func init() {
	...
	groupDescProfitControlEnabled := groupFields[48].Descriptor()
	...
	groupDescProfitMinMargin := groupFields[49].Descriptor()
	...
	groupDescProfitSafetyBuffer := groupFields[50].Descriptor()
